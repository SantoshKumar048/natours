...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FudG9zaGt1bXIwNDgiLCJhIjoiY2tpNHA4dWQyMW1pdjJxbXNmOGloZXVzbiJ9.wMNcV1r0h6XQWB8sHHAnAg';
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Define Marker
    ...
    bounds.extend(loc.coordinates); // new mapboxgl.addLayer({
    //   id: `${loc.description}`,
    //   type: line,
    // });
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              // it will go to directly to user routes
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('Error', 'Errorlogging out! try again');
...
var stripe = Stripe('pk_test_51Hvjb0GgWsQuQMfsWjEMlrKEYV9T8zH6NAwAIF96ohUwvYfNRV8K5IUuMSAELngcVGLvUV96YZRhUyw1ulRJV19k00cslwvae7');
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var formData = new FormData(); // using append we  add key/ value pair to formData
  ...
  (0, _updateSettings.updateSettings)(formData, 'data'); // const name = document.getElementById('name').value; // we have to take name and email otherwaise it won't work don't take newName bacause in db its name
  // const email = document.getElementById('email').value;
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.textContent = 'Processing....'; //const tourId = e.target.dataset.tourId; // we can use destructuring here
